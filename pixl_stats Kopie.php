      ...
      <table>
        ...
        <?php foreach ($topUserAgents as $row): ?>
          <tr>
            ...
            <td><?= pixl_h($row['count']) ?></td>
            <td>
              <span class="badge <?= (int)$row['is_bot'] === 1 ? 'bot' : 'human' ?>" title="<?= (int)$row['is_bot'] === 1 ? 'B' : 'H' ?>">
                <?= (int)$row['is_bot'] === 1 ? 'B' : 'H' ?>
              </span>
              <div class="muted"><?= (int)$row['is_bot'] === 1 ? pixl_h(pixl_compact_label($row['bot_category'])) : 'Human' ?></div>
            </td>
      ...
      <table>
        ...
        <?php foreach ($recentBots as $row): ?>
          <tr>
            ...
            <td><span class="badge bot" title="<?= pixl_h($row['bot_name'] ?: 'Bot') ?>">B</span><div class="muted"><?= pixl_h($row['bot_category']) ?></div></td>
            <td><?= pixl_h($row['bot_score']) ?></td>
        ...
        <?php foreach ($recent as $row): ?>
          ...
          <tr class="<?= (int)$row['is_bot'] === 1 ? 'is-bot' : 'is-human' ?>">
            ...
            <td>
              ...
              <div class="muted"><?= (int)$row['is_bot'] === 1 ? pixl_h(pixl_compact_label($row['bot_name'] ?: 'Bot')) : 'Human' ?> <?= pixl_h($row['bot_score']) ?></div>
            </td>
